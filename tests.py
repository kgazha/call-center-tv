...
class TestReportForm01(unittest.TestCase):
    ...
    report.data = (
        ...
        {'value_text': 'Каслинский район', 'name': 'Волонтеры', 'ticket_type_id': 11,
         'frequency': 2, 'complaints': 0, 'complaint_field_id': 37},
        ...
        {'value_text': 'Красноармейский район', 'name': 'Волонтеры', 'ticket_type_id': 11,
         'frequency': 3, 'complaints': None, 'complaint_field_id': None},
        {'value_text': 'Магнитогорский ГО', 'name': 'Волонтеры', 'ticket_type_id': 11,
         'frequency': 1, 'complaints': 0, 'complaint_field_id': 37},
...
class TestReportForm53(unittest.TestCase):
    ...
    report.data = (
        {'field_id': 12, 'value_text': 'иван', 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 9, 10, 27, 5), 'ticket_state_id': 1, 'value_int': None},
        ...
        {'field_id': 17, 'value_text': 'улица: пушкина, дом: колотушкина, кв.: /3', 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 9, 10, 27, 5), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 37, 'value_text': None, 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 9, 10, 27, 5), 'ticket_state_id': 1, 'value_int': 1},

        {'field_id': 12, 'value_text': 'иванов', 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 9, 10, 30, 1), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 14, 'value_text': 'Агаповский', 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 9, 10, 30, 1), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 17, 'value_text': 'улица: , дом: , кв.:', 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 9, 10, 30, 1), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 37, 'value_text': None, 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 9, 10, 30, 1), 'ticket_state_id': 1, 'value_int': 0},

        {'field_id': 12, 'value_text': 'абонент', 'ticket_id': 24,
         'create_time': datetime.datetime.now(), 'ticket_state_id': 1, 'value_int': None},
        ...
        {'field_id': 16, 'value_text': '+7123456789', 'ticket_id': 24,
         'create_time': datetime.datetime.now(), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 37, 'value_text': None, 'ticket_id': 24,
         'create_time': datetime.datetime.now(), 'ticket_state_id': 1, 'value_int': None},
    )
...
class TestReportForm54(unittest.TestCase):
    ...
    report.data = (
        {'field_id': 12, 'value_text': 'иван', 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 2, 10, 27, 5), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 14, 'value_text': 'Аgapovski', 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 2, 10, 27, 5), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 15, 'value_text': 'агаповка', 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 2, 10, 27, 5), 'ticket_state_id': 1, 'value_int': None},
        ...
        {'field_id': 17, 'value_text': 'улица: пушкина, дом: колотушкина, кв.: /3', 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 2, 10, 27, 5), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 37, 'value_text': None, 'ticket_id': 19,
         'create_time': datetime.datetime(2019, 4, 2, 10, 27, 5), 'ticket_state_id': 1, 'value_int': 1},

        {'field_id': 12, 'value_text': 'иванов', 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 3, 10, 30, 1), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 14, 'value_text': 'Агаповский', 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 3, 10, 30, 1), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 17, 'value_text': 'улица: , дом: , кв.:', 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 3, 10, 30, 1), 'ticket_state_id': 1, 'value_int': None},
        {'field_id': 37, 'value_text': None, 'ticket_id': 20,
         'create_time': datetime.datetime(2019, 4, 3, 10, 30, 1), 'ticket_state_id': 1, 'value_int': 0},
